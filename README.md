...
| 項目 | 内容 |
|---|---|
| 設計書 | `docs/DESIGN.md` 822行（8章＋付録4）。**コードより先に設計書を直す**運用 |
| 自動テスト | pytest **305件**（本番コード 3,063行、テスト16ファイル） |
...
![ふんふんbotの「！つかいかた」](images/funfun-bot.png)

`！つかいかた` は全部を並べません。**まず3つだけ**出して、必要な人だけが
`！つかいかた 全部` で残りを見られるようにしています。コマンドが増えても
最初の画面が重くならない作りです。
